        ...
        child: Stack(
          ...
          children: [
            ...
            widget.dotIndicator == null
                ? const SizedBox()
                : Positioned(
                    bottom: widget.dotIndicator?.position == DotIndicatorPosition.bottom
                        ? widget.dotIndicator?.space
                        : null,
                    ...
                    left:
                        widget.dotIndicator?.position == DotIndicatorPosition.left ? widget.dotIndicator?.space : null,
                    child: SizedBox(
